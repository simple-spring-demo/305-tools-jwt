package com.sxqibo.spring.util;
...
public class JwtOperator {
   ...
   //
   //     // 将我改成上面生成的token!!!
   //     String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE3MDU5OTE1NTUsImV4cCI6MTcwNzIwMTE1NX0.HLhzEX8TScEwlTGFyj97M9F5slOD5phVYh1vqnGAnhA";
   ...
   //     String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE3MDU5OTE1NTUsImV4cCI6MTcwNzIwMTE1NX0";
   //     // 测试5: 解密Payload
